...
//	@NotBlank(message = "El dni no puede estar vacío") // Asegura que el dni no sea null o esté vacío
//	@Size(min = 1, max = 9, message = "Un mínimo de 1 y máximo de 9 caracteres") // Limita la longitud del dni
//	private String dni;
