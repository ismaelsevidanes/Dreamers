package com.dreamers.api.error;
...
import com.dreamers.api.dtos.response.error.ErrorDetailsResponse;
import com.dreamers.api.error.exception.CampoNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetailsResponse> handleLibroNotFoundException(CampoNotFoundException ex, WebRequest request) {
    	ErrorDetailsResponse errorDetails = new ErrorDetailsResponse(
            new Date(),
            ex.getMessage(),
            request.getDescription(false));
